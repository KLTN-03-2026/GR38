...
const SidebarTeacher = () => {
  ...
  return (
    <>
      ...
      <aside
        className="w-[220px] fixed top-0 left-0 h-screen bg-white border-r border-gray-100 flex flex-col z-30"
      ...
      >
        ...
        <div className="px-4 py-4 border-b border-gray-100 flex items-center gap-2.5">
          ...
          <div>
            <p className="text-[13px] font-semibold text-gray-800 leading-tight">Lịch sử Việt Nam</p>
            <p className="text-[10px] text-gray-400 leading-tight mt-0.5">Giáo viên</p>
          </div>
        </div>

        {/* Nav */}
        <nav className="flex-1 py-2 overflow-y-auto">
          <div className="section-label">Chính</div>
          ...
          <div className="section-label" style={{ marginTop: 8 }}>Quản lý</div>
