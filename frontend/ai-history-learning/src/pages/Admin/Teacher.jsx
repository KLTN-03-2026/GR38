...
const stats = [
  ...
  { label: "Tổng tài liệu",     value: "500",          Icon: BookOpen,      color: "#1473E6", bg: "#EEF4FF", trend: "+5%"  },
  { label: "FlashCard",          value: "510",          Icon: LayoutGrid,    color: "#0EA472", bg: "#EEFAF5", trend: "+8%"  },
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 32 }}>
        <div>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 800, color: "#111827", margin: 0, lineHeight: 1.2 }}>
            {greeting}, <span style={{ color: "#F26739" }}>Giáo viên</span>
          </h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 18, marginBottom: 24 }}>
        {stats.map((s, i) => (
          <div key={i} className="stat-card" style={{ background: "#fff", borderRadius: 18, padding: "22px 20px", boxShadow: "0 2px 12px rgba(0,0,0,.06)", position: "relative", overflow: "hidden" }}>
            ...
            <p style={{ fontSize: 26, fontWeight: 800, color: "#111827", margin: "0 0 4px" }}><AnimatedNumber target={s.value} /></p>
