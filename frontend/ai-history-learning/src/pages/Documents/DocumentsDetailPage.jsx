...
export default function DocumentsDetailPage() {
  ...
  /* ── Load quiz list when tab active ── */
  useEffect(() => {
    if (activeTab === "Quizz") loadQuizList();
  }, [activeTab]);

  /* ── Load flashcard list when tab active ── */
  useEffect(() => {
  ...
  const handleGenerateQuiz = async () => {
    try {
      ...
      await axios.post(`${API}/quizzes/generate`, { documentId: id }, { headers });
  ...
  const handleGenerateFlash = async () => {
    try {
      ...
      await axios.post(`${API}/flashcards/generate`, { documentId: id }, { headers });
