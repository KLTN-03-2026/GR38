...
const DEFAULT_FLASHCARD = [
  { id: "khang-chien", title: "Kháng chiến chống mỹ", cards: 10, progress: 40, image: imgKhangChien, source: "default" },
  { id: "tien-su", title: "Lịch sử Việt Nam thời tiền sử", cards: 10, progress: 30, image: imgThoiTienSu, source: "default" },
  { id: "quan-chu", title: "Thời kỳ quân chủ (939 - 1945)", cards: 10, progress: 45, image: imgQuanChu, source: "default" },
  { id: "bac-thuoc", title: "Thời bắc thuộc (180 TCN - 938)", cards: 10, progress: 20, image: imgBacThuoc, source: "default" },
  { id: "hien-dai", title: "Thời kỳ hiện đại (1858 - nay)", cards: 10, progress: 60, image: imgHienDai, source: "default" },
  { id: "dien-bien-phu", title: "Chiến tranh Điện Biên Phủ", cards: 10, progress: 15, image: imgDienBienPhu, source: "default" },
];
...
const Flashcards = () => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    if (item.source === "custom") {
      const local = JSON.parse(localStorage.getItem("flashcards") || "[]");
      const updated = local.filter((i) => String(i.id) !== String(item.id));
