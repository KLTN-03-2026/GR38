...
const Baikiemtra = () => {
  ...
  const [tempAnswer, setTempAnswer] = useState(null); // Lưu lựa chọn tạm thời trước khi ấn "Lưu"
  const [answers, setAnswers] = useState({}); // Chỉ lưu những câu ĐÃ ẤN NÚT LƯU
  const [timeLeft, setTimeLeft] = useState(600); // GIẢM CÒN 10 PHÚT
  ...
  // Cập nhật lựa chọn tạm thời khi đổi câu hỏi
  useEffect(() => {
  ...
  const handleSaveAnswer = () => {
    ...
    // Giả lập thời gian delay gửi lên server
    setTimeout(() => {
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1">
            <div className="bg-white p-10 rounded-2xl border border-[#E4E4E7] shadow-sm relative min-h-[400px]">
              ...
              {/* Status hiển thị Lưu thành công/thất bại */}
