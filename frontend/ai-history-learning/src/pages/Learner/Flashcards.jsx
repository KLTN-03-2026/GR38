      ...
      <div className="w-full max-w-[1400px]">
            ...
            <div key={item.id} className="flex flex-col group bg-white p-4 rounded-[24px] shadow-sm border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
              ...
              <div className="w-full h-[210px] overflow-hidden rounded-[18px] mb-5 bg-gray-50 shadow-inner">
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = "https://via.placeholder.com/400x220?text=History+Image";
                  }}
                />
              </div>
              ...
              <div className="px-2">
                ...
                <button 
                  onClick={() => navigate(`/flashcards/${item.id}`)}
                  className="w-full bg-[#F26739] text-white py-3.5 rounded-xl font-bold text-[15px] hover:bg-[#d9562d] transition-colors shadow-lg shadow-orange-100 active:scale-[0.97]"
                >
                  Bắt đầu học ngay
                </button>
              </div>
        ...
        {filteredData.length === 0 && (
          <div className="text-center py-20 text-gray-400">
            Không tìm thấy bộ dữ liệu nào phù hợp với từ khóa.
          </div>
        )}
      </div>
    </div>
