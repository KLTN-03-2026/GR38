...
const Baikiemtra = () => {
  ...
  // Gộp thành 1 useEffect duy nhất, không lồng nhau
  useEffect(() => {
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="flex-1 bg-white p-8 rounded-xl border border-[#E4E4E7] shadow-sm">
              ...
              <div className="mt-8 bg-[#81F69F] rounded-2xl p-6 flex flex-col items-center justify-center h-48 border border-green-300">
                <div className="text-5xl font-black text-[#10B981]">SCORE {score}/{total}</div>
              </div>
              <button
                onClick={() => navigate(-1)}
      ...
      <div className="w-full max-w-[1280px]">
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            {doc?.title && <h2 className="text-xl font-bold mt-4 uppercase">{doc.title}</h2>}
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mt-8">
              ...
              <div className="flex gap-4">
                <button onClick={() => setCurrentIdx(0)} className="bg-orange-500 text-white px-8 py-2 rounded-full font-bold hover:bg-orange-600 transition-all shadow-md">
                  Quay lại câu đầu
                </button>
                <button onClick={handleSubmit} className="bg-[#F26739] text-white px-8 py-2 rounded-full font-bold hover:opacity-90 shadow-md">
                  Nộp Bài
                </button>
              </div>
              <div className="flex gap-2">
                <button disabled={currentIdx === 0} onClick={() => setCurrentIdx((p) => p - 1)} className="p-2 bg-white border rounded hover:bg-gray-50 disabled:opacity-30">
                  <ChevronLeft />
                </button>
                <button disabled={currentIdx === total - 1} onClick={() => setCurrentIdx((p) => p + 1)} className="p-2 bg-white border rounded hover:bg-gray-50 disabled:opacity-30">
                  <ChevronRight />
                </button>
              </div>
            </div>
